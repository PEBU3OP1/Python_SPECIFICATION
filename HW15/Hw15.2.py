...
logging.basicConfig(filename='parsing_and_date_translation.log', format=FORMAT, level=logging.INFO, filemode='a',
...
def command_line_data_parser():
    ...
    parser.add_argument('line_str', metavar='L', type=str, nargs='*',
                        help='enter a line of text - 1 четверг ноября \\ 1 4 11')
